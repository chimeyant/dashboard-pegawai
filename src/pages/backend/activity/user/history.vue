...
export default {
  ...
  setup() {
    ...
    const endpoint = "api/v2/activity/task-history/";

    const winheight = window.innerHeight - 320;
    const headers: {}[] = [
      { title: "Waktu", key: "tanggal", align: "center", width: 200 },
    ...
    onMounted(() => {
      store.setPage({
        ...
        subtitle: "Berikut Daftar Seluruh History Anda Yang Tersedia ",
