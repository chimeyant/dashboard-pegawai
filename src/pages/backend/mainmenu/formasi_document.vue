<template>
  <v-row :class="device.mobile || device.tablet ? `` :`mx-1 mt-1`">
    ...
    <div>
      ...
      >
        <div>
          <div class="title font-weight-bold">Modul Dokumen Persyaratan</div>
          <br>
          <div>
            <p class="text-body-2">
              Modul ini berfungsi untuk melakukan penambahan, perubahan dan penghapusan dokumen pesyaratan untuk formasi terkait
            </p>
          </div>
        </div>
      </form-helper>
...
export default {
  ...
  setup() {
    ...
    const endpoint =
      "api/v1/main-menu/formasi-document/" + route.params.formasi_uuid + "/";
    ...
    onMounted(() => {
      store.setPage({
        title: "Formasi Dokumen Persyaratan",
        subtitle: "Berikut Daftar Dokumen Yang Tersedia ",
        dataUrl: endpoint,
        actions: {
          refresh: true,
          add: true,
