<template>
  <v-row :class="device.mobile || device.tablet ? `` :`mx-1 mt-1`">
    ...
    <v-col cols="12">
      <frame-form
        title="Formulir Master Template Dokumen"
        width="600"
        @btnAdd="postRecord"
        @btnEdit="postUpdate"
    ...
    <div>
      ...
      >
        <div>
          <div class="title font-weight-bold">Modul Template Dokumen</div>
          <br>
          <div>
            <p class="text-body-2">
              Modul ini berfungsi untuk melakukan penambahan, perubahan dan penghapusan template dokumen
            </p>
          </div>
        </div>
      </form-helper>
...
export default {
  ...
  setup() {
    ...
    const endpoint = "api/v1/master-data/document-template/";
    ...
    const headers:{}[] = [
      ...
      { title: "WAJIB", key: "wajib", align: "center" , sortable:false},
    ...
    onMounted(() => {
      store.setPage({
        title: "Master Template Dokumen",
        subtitle: "Berikut Daftar Template Dokumen Yang Tersedia ",
        dataUrl: endpoint,
        actions: {
          refresh: true,
          add: true,
