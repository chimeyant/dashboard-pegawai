...
export default {
  ...
  setup() {
    ...
    const endpoint = "api/v2/master-data/group-service/"+ route.params.tos_uuid +"/";
    ...
    onMounted(() => {
      store.setPage({
        title: "Group Pelayanan",
        subtitle: "Berikut Daftar Seluruh Group Pelayanan Yang Tersedia ",
        dataUrl: endpoint,
        actions: {
          refresh: true,
          add: true,
