    ...
    <div>
      ...
      >
        <div>
          ...
          <div>
            <p class="text-body-2">
              Modul ini berfungsi untuk melakukan penambahan, perubahan dan penghapusan data jenis kerugian daerah
            </p>
          </div>
        </div>
      </form-helper>
...
export default {
  ...
  setup() {
    ...
    const endpoint = "api/v1/master-data/jenis-informasi-kerugian-daerah/";
    ...
    onMounted(() => {
      store.setPage({
        title: "Jenis Kerugian Daerah",
        subtitle: "Berikut Daftar Seluruh Jenis Kerugian Daerah Yang Tersedia ",
        dataUrl: endpoint,
        actions: {
          refresh: true,
          add: true,
