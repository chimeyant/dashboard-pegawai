        ...
        <v-row>
          ...
          <v-col cols="12">
            <v-autocomplete
              ...
              hide-details="auto"
              :items="suratPenagihans ? suratPenagihans :[]"
              :color="theme.color"
            ></v-autocomplete>
          </v-col>
...
export default {
  ...
  setup() {
    ...
    const endpoint = "api/v1/sidakuda/surat-peringatan/";
    ...
    const peringatans = ref([
      {
        title: "Peringatan Ke-1",
        value: 1,
      },
      {
        title: "Peringatan Ke-2",
        value: 2,
      },
    ]);
    ...
    onMounted(() => {
      store.setPage({
        ...
        subtitle: "Berikut Daftar Surat Peringatan Yang Tersedia ",
        dataUrl: endpoint,
        actions: {
          refresh: true,
          add: true,
