<template>
  ...
  >
    <div>
      ...
      <div class="mt-16">
        <h3 class="mb-5">Selamat Bergabung...!</h3>
        <p class="text-body-2">
          Proses registrasi anda berhasil, silahkan menunggu pesan terkait akun dan password anda dalam beberapa saat akan dikirim melalui Whatsapp Messenger"
        </p>
      </div>
